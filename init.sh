...
export FCCEDM=/afs/cern.ch/work/d/drasal/fcc/FCC-PODIO/fcc-edm/install #/afs/cern.ch/exp/fcc/sw/0.5/fcc-edm/0.1/x86_64-slc6-gcc49-opt/
export ALBERS=/afs/cern.ch/work/d/drasal/fcc/FCC-PODIO/podio/install #afs/cern.ch/exp/fcc/sw/0.5/albers-core/0.1/x86_64-slc6-gcc49-opt
