...
from Configurables import PodioInput, PodioMerge
podin = PodioInput()
podin.DataOutputs.trackHits.Path = "fileHits"
podin.DataOutputs.trackClusters.Path = "fileClusters"
podin.DataOutputs.trackHitsClusters.Path = "fileHitsClusters"
merge = PodioMerge()
merge.DataInputs.fileHits.Path = "fileHits"
merge.DataInputs.trackHitsIn.Path = "hits"
merge.DataOutputs.trackHitsOut.Path = "fileHitsMerged"
...
ApplicationMgr( TopAlg = [reader, hepmc_converter, geantsim, podin, merge, out],
                EvtSel = 'NONE',
                EvtMax   = 1,
