...
//  Modified by Clement Helsens on 06/01/16
//
...
static Ref_t create_element(LCDD& lcdd, xml_h e, SensitiveDetector sens)
{
    ...
    xml_comp_t x_tubs  =  x_det.child( _U(tubs) ) ;
    ...
    Tube tube_shape(x_det_dim.rmin(),x_det_dim.rmax(),x_det_dim.z(), x_det_dim.phi0(), x_det_dim.deltaphi());
    //Volume tube_vol(det_name,tube_shape,lcdd.air()); //air at the moment change later
    Volume tube_vol(det_name,tube_shape,lcdd.material(x_tubs.materialStr()));
