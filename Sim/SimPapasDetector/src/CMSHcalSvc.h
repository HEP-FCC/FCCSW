...
private:
  ...
  Gaudi::Property<std::vector<std::vector<double>>> m_eres {this, "eres", {{0.8062, 2.753, 0.1501}, {6.803e-06, 6.676, 0.1716}}, "Hcal energy resolution parameters "};
  Gaudi::Property<std::vector<std::vector<double>>> m_eresp {this, "eresp", {{1.036, 4.452, -2.458}, {1.071, 9.471, -2.823}}, "Hcal energy response parameters "};
  Gaudi::Property<std::vector<double>> m_acceptanceParameters{this, "acceptanceParameters", {1.,
    1.,           -1.9381,     -1.75330,    3.,       1.1,      10., 1.05634,
    -1.66943e-01, 1.05997e-02, 8.09522e-01, -9.90855, -5.30366, 5.,  7.}, "Hcal  acceptance parameters vector"};
