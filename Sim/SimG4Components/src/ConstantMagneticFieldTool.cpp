...
// local
#include "ConstantMagneticFieldTool.h"
...
//-----------------------------------------------------------------------------
// Implementation file for class : ConstantMagneticFieldTool
//
// 2014-10-01 : Andrea Dell'Acqua
//-----------------------------------------------------------------------------

// Declaration of the Tool
DECLARE_COMPONENT( ConstantMagneticFieldTool )

//=============================================================================
// Standard constructor, initializes variables
//=============================================================================
ConstantMagneticFieldTool::ConstantMagneticFieldTool( const std::string& type,
...
ConstantMagneticFieldTool::~ConstantMagneticFieldTool()
{
}
...
// Initialize 
//=============================================================================
StatusCode ConstantMagneticFieldTool::initialize( )
{
	info()<<" ConstantMagneticFieldTool::initialize( ) "<<endmsg;
	StatusCode sc = GaudiTool::initialize( ) ;
	if ( sc.isFailure() ) return sc ;
	
	if (m_fieldOn) 
	{
		m_field = new ConstantField();
	...
	info()<<" done!!! ConstantMagneticFieldTool::initialize( ) "<<endmsg;
	return sc;
}
...
// Finalize 
//=============================================================================
StatusCode ConstantMagneticFieldTool::finalize( )
{
	info()<<" ConstantMagneticFieldTool::finalize( ) "<<endmsg;
	StatusCode sc = GaudiTool::initialize( ) ;
	return sc;
}

G4MagneticField* ConstantMagneticFieldTool::getField() const
{
	return m_field;
}
...
G4MagIntegratorStepper* ConstantMagneticFieldTool::GetStepper(std::string name, G4MagneticField* field) const
{
