...
private:
  ...
  Gaudi::Property<std::vector<double>> m_ptList{
      this, "PtList", {}, "List of transverse momenta to generate"};
  StatusCode saveToEdm(std::vector<G4PrimaryVertex*>, std::vector<G4PrimaryParticle*>);
  ...
  Gaudi::Property<std::vector<unsigned int>> m_nTracksList{this, "nTracks", {1}};
  /// Name of the generated particle, set with particleName
  Gaudi::Property<std::string> m_particleName{this, "particleName", "chargedgeantino", "Name of the generated particles"};
  /// Flag whether to save primary particle to EDM, set with saveEdm
  Gaudi::Property<bool> m_saveEdm{this, "saveEdm", false};
  /// Handle for the genparticles to be written
  DataHandle<fcc::MCParticleCollection> m_genParticlesHandle{"allGenParticles", Gaudi::DataHandle::Writer, this};
  /// Handle for the genvertices to be written
  DataHandle<fcc::GenVertexCollection> m_genVerticesHandle{"allGenVertices", Gaudi::DataHandle::Writer, this};
};
