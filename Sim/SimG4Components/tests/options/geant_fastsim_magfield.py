...
from Configurables import G4SimSvc, G4FastSimPhysicsList, G4FastSimActions, G4ParticleSmearSimple, G4ConstantMagneticFieldTool
...
# create magnetic field tool
field = G4ConstantMagneticFieldTool("MagField", FieldOn=True)
# attach those tools to the G4 service
geantservice = G4SimSvc("G4SimSvc", detector='G4DD4hepDetector', physicslist=physicslisttool, actions=actionstool, magneticField=field)
