...
namespace sim {
GdmlDetectorConstruction::GdmlDetectorConstruction(const std::string& aFileName): m_fileName(aFileName),
...
void GdmlDetectorConstruction::ConstructSDandField() {
  ...
  // TODO: uncomment, use a proper implementation of the SensitiveDetector,
  ...
  */
  ...
  for(auto& entry: *auxMap) {
    ...
    if (info.type=="SensDet") {
      ...
      // TODO: uncomment to really attach SD registered above
      /*
