#Tue May 12 17:23:12 2015"""Automatically generated. DO NOT EDIT please"""
from GaudiKernel.DataObjectDescriptor import *
from GaudiKernel.Proxy.Configurable import *

class DelphesSimulation( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
    ...
    'Outputs' : DataObjectDescriptorCollection("electrons|NULL|0|1#genparticles|NULL|0|1#hts|NULL|0|1#jets|NULL|0|1#mets|NULL|0|1#muons|NULL|0|1#particles|NULL|0|1#partons|NULL|0|1#photons|NULL|0|1"), # DataDescriptorCollection
  ...
  _propertyDocDct = { 
    ...
    'debug_delphes' : """ boolean,if true one runs delphes standalone and a separate output is saved """,
    ...
    'outputcollections' : """ strings of ouput corrections, corresponding to the one wrote by Delphes """,
    'detectorcard' : """ Name of the tcl file with detector and simulation configuration """,
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(DelphesSimulation, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'Simulation'
  def getType( self ):
      return 'DelphesSimulation'
  pass # class DelphesSimulation

class DummySimulation( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
    ...
    'Outputs' : DataObjectDescriptorCollection("particles|NULL|0|1"), # DataDescriptorCollection
    'AuditAlgorithms' : False, # bool
    'AuditInitialize' : False, # bool
    'AuditReinitialize' : False, # bool
    'AuditRestart' : False, # bool
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(DummySimulation, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'Simulation'
  ...
  pass # class DummySimulation

class Geant4Simulation( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
    'ErrorCount' : 0, # int
    'Inputs' : DataObjectDescriptorCollection("hepmcevent|NULL|0|0"), # DataDescriptorCollection
  ...
  def __init__(self, name = Configurable.DefaultName, **kwargs):
      super(Geant4Simulation, self).__init__(name)
      for n,v in kwargs.items():
         setattr(self, n, v)
  def getDlls( self ):
      return 'Simulation'
  def getType( self ):
      return 'Geant4Simulation'
  pass # class Geant4Simulation

class Simulation( ConfigurableAlgorithm ) :
  __slots__ = { 
    'OutputLevel' : 0, # int
    'Enable' : True, # bool
    'ErrorMax' : 1, # int
