...
# their PDG code (default = 12)
from Configurables import FlatNParticles
ParticleGun.addTool(FlatNParticles, name="FlatNParticles")
ParticleGun.NumberOfParticlesTool = "FlatNParticles"
ParticleGun.FlatNParticles.MinNParticles = 10
ParticleGun.FlatNParticles.MaxNParticles = 10
# ParticleGun.MaterialEval.PdgCode    = 12
...
# given point. 
#ParticleGun.MaterialEval.Xorig = 0.0*mm
#ParticleGun.MaterialEval.Yorig = 0.0*mm
#ParticleGun.MaterialEval.Zorig = 0.0*mm

# The abs(P) of the particle if fixed at the given value (default = 500 GeV)
#ParticleGun.MaterialEval.ModP = 500.0 * GeV
...
#ParticleGun.MaterialEval.ZPlane = 10.0*m
#ParticleGun.MaterialEval.Xmin   = -3.2*m
#ParticleGun.MaterialEval.Ymin   = -2.6*m
#ParticleGun.MaterialEval.Xmax   =  3.2*m
#ParticleGun.MaterialEval.Ymax   =  2.6*m
...
#ParticleGun.MaterialEval.MinEta = 2.1
#ParticleGun.MaterialEval.MaxEta = 4.9
#ParticleGun.MaterialEval.MinPhi = 0.0*rad
#ParticleGun.MaterialEval.MaxPhi = 6.28*rad 

# A regular grid of given steps can be used instead of a randomly uniform
# distribution (default = false)
ParticleGun.MaterialEval.UseGrid = True
