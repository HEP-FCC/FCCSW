...
saveecaltool = SimG4SaveCalHits("saveHCalHits",readoutNames = ["BarHCal_Readout"])
saveecaltool.DataOutputs.positionedCaloHits.Path = "HCalPositionedHits"
saveecaltool.DataOutputs.caloHits.Path = "HCalHits"
...
out.filename = "output_hcalSim_pi50GeV_eta036_10events.root"
