...
def cellPosDd4hep(cellId):
    ...
    return array('d',((x(cellId)-cellNo/2)*cellSize,(y(cellId)-cellNo/2)*cellSize,(0.5+z(cellId))*cellSize))
...
storeDD4hep = EventStore(["physicalcells_dd4hep.root"])
...
print(dd4hepPos)
print("TEST:",cellPosDd4hep(6644994))
