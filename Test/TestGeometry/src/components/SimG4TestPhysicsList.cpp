...
SimG4TestPhysicsList::SimG4TestPhysicsList(const std::string& aType, const std::string& aName, const IInterface* aParent) :
...
StatusCode SimG4TestPhysicsList::initialize() {
  return AlgTool::initialize();
}

StatusCode SimG4TestPhysicsList::finalize() {
