...
geoservice = GeoSvc("GeoSvc", detectors=['file:Detector/DetFCCehBaseline1/compact/FCCeh_DectEmptyMaster.xml',
  'file:Detector/DetFCCehTrackerTkLayout/compact/Tracker.xml'],
                    OutputLevel = INFO)
