...
static DD4hep::Geometry::Ref_t createLayeredCone(DD4hep::Geometry::LCDD& lcdd,
  ...
  DD4hep::Geometry::Cone envelope(dimensions.dz(),
                                  dimensions.rmin1(),
                                  dimensions.rmax1(),
                                  dimensions.rmin2(),
                                  dimensions.rmax2());
  ...
  for(unsigned layerIdx = 0; layerIdx < numLayers; ++layerIdx) {
    ...
    DD4hep::Geometry::Cone layerShape(layerDet.dz(),
                                      layerDet.rmin1(),
                                      layerDet.rmax1(),
                                      layerDet.rmin2(),
                                      layerDet.rmax2());
  ...
  DD4hep::Geometry::PlacedVolume envPhys = experimentalHall.placeVolume(envVolume,
                                                DD4hep::Geometry::Transform3D(DD4hep::Geometry::RotationZ(0.),
                                                trans));
