...
DD4hep::XML::Component det::getNodeByStrAttr(DD4hep::XML::Handle_t mother, const char* nodeName, const char* attrName,
...
double det::getDoubleWithDefault(DD4hep::XML::Component node, const char* attrName, double defaultValue) {
