...
savetrackertool = SimG4SaveTrackerHits("SimG4SaveTrackerHits", readouts = ["TrackerSiliconHits"])
...
out = PodioOutput("out", OutputLevel=DEBUG, filename="out_dd4hepTrackerSD_2cm.root")
