...
static DD4hep::Geometry::Ref_t create_detector(DD4hep::Geometry::LCDD& lcdd,
    ...
    DD4hep::DDRec::LayeredConicalCalorimeterData* caloData = new DD4hep::DDRec::LayeredConicalCalorimeterData ;
    caloData->layoutType = DD4hep::DDRec::LayeredConicalCalorimeterData::EndcapLayout ;
    ...
    caloData->extent[2] = rInnerEnd ;
    caloData->extent[3] = rOuterEnd ;
    caloData->extent[4] = lcalInnerZ ;
    caloData->extent[5] = lcalInnerZ + lcalThickness ;
	...
	double rOut2 = 0 ; 
	    ...
	    int sliceID=0;
            ...
            DD4hep::DDRec::LayeredConicalCalorimeterData::Layer caloLayer ;
    ...
    sdet.addExtension< DD4hep::DDRec::LayeredConicalCalorimeterData >( caloData ) ;
