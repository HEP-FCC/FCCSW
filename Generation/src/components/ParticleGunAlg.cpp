...
ParticleGunAlg::ParticleGunAlg(const std::string& name, ISvcLocator* pSvcLocator) : GaudiAlgorithm(name, pSvcLocator) {
...
StatusCode ParticleGunAlg::finalize() { return GaudiAlgorithm::finalize(); }
