...
class BarrelLayerGraphTool6 : public GaudiTool, virtual public ILayerGraphTool {
public:
  BarrelLayerGraphTool6(const std::string& type, const std::string& name, const IInterface* parent);
  ~BarrelLayerGraphTool6() = default;
