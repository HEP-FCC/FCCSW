...
pgun = SimG4SingleParticleGeneratorTool("GeantinoGun", phiMin=0, nTracks=[8,16,32], phiMax=constants.pi*2, etaMin=-1, etaMax=1, 
                          PtList=[
                          1000, 
                            2000, 5000, 
                             10000, 
                            100000, 1000000, 1e7 ], 
                          energyMin=100000, energyMax=100000, particleName="chargedgeantino", saveEdm=True, OutputLevel=INFO)
...
out.filename = "geantinosForSeeding_ntracks_barrelOnly.root"
