...
out = PodioOutput("out", filename = "output_BarrelTopoCalib_50GeVe_3ev.root",
                  OutputLevel=DEBUG)
out.outputCommands = ["drop *", "keep GenParticles", "keep GenVertices", "keep caloClustersBarrel", "keep caloClusterBarrelCells", "keep calibCaloClustersBarrel", "keep calibCaloClusterBarrelCells", "keep caloClusterBarrelCellPositions"]
...
calibrateClusters.AuditExecute = True
