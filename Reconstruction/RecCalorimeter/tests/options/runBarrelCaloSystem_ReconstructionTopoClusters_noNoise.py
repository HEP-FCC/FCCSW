...
#Create topo clusters
                                                  from Configurables import CreateEmptyCaloCellsCollection
                                                      createemptycells =
                                                          CreateEmptyCaloCellsCollection("CreateEmptyCaloCells")
    ...
    from Configurables import CaloTopoClusterInputTool,
                      ...
                      TopoCaloNoisyCells createTopoInput =
                          CaloTopoClusterInputTool("CreateTopoInput",
                              ...
                              "ECalBarrelCells" createTopoInput.ecalEndcapCells.Path =
                                  "emptyCaloCells" createTopoInput.ecalFwdCells.Path =
                                      "emptyCaloCells" createTopoInput.hcalBarrelCells.Path =
                                          "HCalBarrelCells" createTopoInput.hcalExtBarrelCells.Path =
    ...
    from Configurables import AuditorSvc,
                      ChronoAuditor chra = ChronoAuditor() audsvc = AuditorSvc() audsvc.Auditors =
                          [chra] podioinput.AuditExecute = True createemptycells.AuditExecute =
                              True createTopoClusters.AuditExecute = True positionsClusterBarrel.AuditExecute =
                                  True out.AuditExecute = True
