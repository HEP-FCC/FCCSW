#include "CellPositionsHCalBTool.h"
...
CellPositionsHCalBTool::CellPositionsHCalBTool(const std::string& type, const std::string& name, const IInterface* parent)
...
void CellPositionsHCalBTool::getPositions(const fcc::CaloHitCollection& aCells, fcc::PositionedCaloHitCollection& outputColl) {
  double radius;  
